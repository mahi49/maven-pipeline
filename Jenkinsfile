     ...
     stage('Package') {
	     ...
	     stage('deploy') {
            steps {
               ...
               sh "scp -o StrictHostKeyChecking=no /var/lib/jenkins/workspace/pipeline-project2/target/maven-web-application.war ubuntu@54.175.211.150:/opt/apache-tomcat-9.0.59/webapps"
        }
        }
    }
	}
